import 'package:MOrder/views/PRODUCTCATALOGUE/singleProductDetails.dart';
...
class AllProductCatalogueRanges extends StatefulWidget {
  final int supplierId;

  AllProductCatalogueRanges(this.supplierId);
  @override
  _AllProductCatalogueRangesState createState() => _AllProductCatalogueRangesState();
}

class _AllProductCatalogueRangesState extends State<AllProductCatalogueRanges> {
